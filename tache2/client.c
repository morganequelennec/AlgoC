...
void analyse(char *pathname, char *data, char* numCouleurs) {
  //compte de couleurs
  couleur_compteur *cc = analyse_bmp_image(pathname);
  int nbCouleurs = atoi(numCouleurs);
  int count;
  strcpy(data, "couleurs: ");
  char temp_string[10];
  strcpy(temp_string, (strcat(numCouleurs, " ,")));
...
int main(int argc, char **argv) {
  ...
  if (argc != 3) {
    ...
    //envoyer et recevoir les X (argv[2] couleurs prédominantes 
